...
class NavigationBar extends Component {
  constructor(props) {
    ...
    this.navigateInscripcionesMostrar = this.navigateInscripcionesMostrar.bind(
      this
    );
    this.navigateInscripcionesCrear = this.navigateInscripcionesCrear.bind(
      this
    );
    this.navigateCursosModulosMostrar = this.navigateCursosModulosMostrar.bind(
      this
    );
    this.navigateCursosModulosCrear = this.navigateCursosModulosCrear.bind(
      this
    );
  }
          ...
          <ul className="navbar-nav">
            <div className="btn-group">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <button
                  onClick={this.navigateUsuariosMostrar}
                ...
                <button
                  onClick={this.navigateUsuariosCrear}
                  className="dropdown-item"
                  type="button"
                >
                  Crear
            ...
            <div className="btn-group">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <button
                  onClick={this.navigateCursosMostrar}
                  className="dropdown-item"
                  type="button"
                >
                  Mostrar
                ...
                <button
                  onClick={this.navigateCursosCrear}
                  className="dropdown-item"
                  type="button"
                >
                  Crear
            ...
            <div className="btn-group">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <button
                  onClick={this.navigateInscripcionesMostrar}
                  className="dropdown-item"
                  type="button"
                >
                  Mostrar
                ...
                <button
                  onClick={this.navigateInscripcionesCrear}
                  className="dropdown-item"
                  type="button"
                >
                  Crear
            ...
            <div className="btn-group">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <button
                  onClick={this.navigateCursosModulosMostrar}
                  className="dropdown-item"
                  type="button"
                >
                  Mostrar
                ...
                <button
                  onClick={this.navigateCursosModulosCrear}
                  className="dropdown-item"
                  type="button"
                >
                  Crear
            ...
            <div className="btn-group">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <button
                  onClick={this.navigateModulosMostrar}
                  className="dropdown-item"
                  type="button"
                >
                  Mostrar
                ...
                <button
                  onClick={this.navigateModulosCrear}
                  className="dropdown-item"
                  type="button"
                >
                  Crear
            ...
            <div className="btn-group">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <button
                  onClick={this.navigateNotasMostrar}
                  className="dropdown-item"
                  type="button"
                >
                  Mostrar
